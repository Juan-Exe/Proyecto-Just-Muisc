 ...
 * @author DAMIANA
 */
public class Login_Artista implements Initializable {
   ...
   @FXML
    ...
    FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/SingUp_Artista.fxml"));
    Parent root = loader.load();
    SingUp_Artista controller = loader.getController();
